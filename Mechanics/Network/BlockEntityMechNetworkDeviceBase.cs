...
{
    public abstract class BlockEntityMechNetworkDeviceBase : BlockEntity, IMechanicalPowerDevice
    {
        ...
        public MechanicalNetwork getNetwork(BlockFacing facing)
        {
        ...
        public BlockFacing getFacing(MechanicalNetwork network)
        {
            return orientation;
        }
        ...
        public void handleMechanicRelayRemoval()
        {
            ...
            foreach (MechanicalNetwork network in getNetworks())
            {
        ...
        public IMechanicalPowerDevice getConnectibleNeighbourDevice(BlockFacing facing)
        {
            return getNeighbourDevice(facing, false);
        }

        public IMechanicalPowerDevice getNeighbourDevice(BlockFacing facing, bool connected)
        {
