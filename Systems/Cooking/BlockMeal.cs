...
namespace Vintagestory.GameContent
{
    ...
    public class BlockMeal : BlockContainer, IBlockMealContainer, IContainedMeshSource, IContainedInteractable, IContainedCustomName, IGroundStoredParticleEmitter, IHandBookPageCodeProvider
    {
        ...
        public override void OnGroundIdle(EntityItem entityItem)
        {
            ...
            if (world.GetBlock(new AssetLocation(Attributes["eatenBlock"].AsString(""))) is not Block eatenBlock) return;
        ...
        public override TransitionState[]? UpdateAndGetTransitionStates(IWorldAccessor world, ItemSlot inslot)
        {
            ...
            if (stacks.Length == 0 &&
                AssetLocation.CreateOrNull(Attributes?["eatenBlock"]?.AsString()) is AssetLocation loc &&
