        ...
        public GuiDialogBlockEntityConditional(BlockPos BlockEntityPosition, string command, bool latching, ICoreClientAPI capi, string title) : base("Conditional block", BlockEntityPosition, capi)
        {
            ...
            SingleComposer =
                ...
                .BeginChildElements(bgBounds)
                    .AddStaticText("Condition (e.g. e[type=gazelle,range=10])", CairoFont.WhiteSmallText(), commmandsBounds)
                    ...
                    .AddStaticText("Condition syntax status", CairoFont.WhiteSmallText(), labelBounds)
                    ...
                    .AddStaticText("Latching", CairoFont.WhiteSmallText(), resultBounds.BelowCopy(30, 13).WithFixedSize(150, 30))
                    .AddHoverText("If latching is enabled, a repeatedly ticked Conditional Block only activates neibouring Command Block once, each time the condition changes", CairoFont.WhiteSmallText(), 250, resultBounds.BelowCopy(25, 10).WithFixedSize(82, 25))
