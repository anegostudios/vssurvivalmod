...
{
    public class CollectibleBehaviorEntityDeconstructTool : CollectibleBehavior
    {
        public CollectibleBehaviorEntityDeconstructTool(CollectibleObject collObj) : base(collObj) { }
        ...
        public override void OnHeldInteractStop(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, ref EnumHandling handling)
        {
            ...
            if (world.Side == EnumAppSide.Server)
            {
                ...
                foreach (var dropStack in dropStacks)
                {
                    ...
                    {
                        world.SpawnItemEntity(dropStack.ResolvedItemstack, entitySel.Entity.Pos.XYZ);
                    }
                }
            }
