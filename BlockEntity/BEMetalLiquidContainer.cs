...
{
    public class BlockEntityLiquidMetalContainer : BlockEntity
    {
        ...
        public BlockEntityLiquidMetalContainer() : base()
        {
        ...
        private void OnClientTick(float dt)
        {
            ...
            if (api.World.Rand.NextDouble() > 0.5)
            {
                ...
                BlockLiquidMetalContainer.smokeHeld.minPos = pos;
                api.World.SpawnParticles(BlockLiquidMetalContainer.smokeHeld);
            }
        }
