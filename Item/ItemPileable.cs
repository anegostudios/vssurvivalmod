...
namespace Vintagestory.GameContent
{
    public abstract class ItemPileable : Item
    {
        ...
        public override void OnHeldInteractStart(ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, bool firstEvent, ref EnumHandHandling handling)
        {
            ...
            var blockMb = byEntity.World.BlockAccessor.GetBlock(onBlockPos) as BlockMultiblock;
            if (blockMb != null)
            {
                be = byEntity.World.BlockAccessor.GetBlockEntity(onBlockPos.AddCopy(blockMb.OffsetInv));
            }
