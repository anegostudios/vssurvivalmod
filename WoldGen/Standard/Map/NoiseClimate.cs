...
{
    public class NoiseClimate : NoiseBase
    {
        public NoiseClimate(long seed) : base(seed)
        {
        }

        public int GetClimateAt(int posX, int posZ)
        {
        ...
        public int GetLerpedClimateAt(double posX, double posZ, int[] climateCache, int sizeX)
        {
            int posXInt = (int)(posX);
            int posZInt = (int)(posZ);
