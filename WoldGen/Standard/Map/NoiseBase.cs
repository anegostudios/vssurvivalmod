...
namespace Vintagestory.ServerMods
{
    public abstract class NoiseBase
    {
        ...
        public static void DebugDrawBitmap(int mode, int[] values, int size, string name)
        {
            DebugDrawBitmap(mode, values, size, size, name);
        }

        public static void DebugDrawBitmap(int mode, int[] values, int sizeX, int sizeZ, string name)
        {
            if (!Debug) return;
            ...
            bmp.Save(name + ".png");
            Console.WriteLine("saved bitmap " + name + ".png");
        }
