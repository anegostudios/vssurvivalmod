...
namespace Vintagestory.GameContent.Mechanics
{
    public class BEBehaviorMPAxle : BEBehaviorMPBase
    {
        ...
        protected override MechPowerPath[] GetMechPowerPaths(BlockFacing fromFacing, EnumTurnDirection turnDir)
        {
            ...
            return new MechPowerPath[] { new MechPowerPath(fromFacing.GetOpposite(), turnDir) };
        }
        ...
        MeshData getStandMesh(string orient)
        {
            ...
            {
                Shape shape = capi.Assets.TryGet("shapes/block/wood/axle-stand-" + orient + ".json").ToObject<Shape>();
                MeshData mesh;
