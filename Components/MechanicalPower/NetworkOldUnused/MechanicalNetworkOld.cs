...
namespace Vintagestory.GameContent.Mechanics
{
    public class MechanicalNetworkOld
    {
        ...
        public MechanicalNetworkOld(MechNetworkManager myManager, long networkId)
        {
        ...
        public void rebuildNetwork()
        {
            ...
            foreach (IMechanicalPowerDeviceOld device in powerRelays)
            {
                if (device != null)
                {
                    device.clearNetwork();
            ...
            {
                bool found = false;
                foreach (MechanicalNetworkOld network in otherNode.getNetworks())
                {
